...
export default function ProgramasError({ error, reset }) {
  useEffect(() => {
    console.error("[ErrorBoundary Programas]", error);
  }, [error]);
  ...
  return (
    <div className="flex items-center justify-center min-h-[50vh] bg-white px-4" role="alert">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-[#05162D] mb-2">Error al cargar programas</h2>
        <p className="text-gray-500 mb-6">No se pudieron cargar los programas. Intenta de nuevo.</p>
