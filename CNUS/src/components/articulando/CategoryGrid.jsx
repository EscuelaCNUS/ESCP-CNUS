  ...
  return (
    <section id={id} className="w-full px-4 tablet:px-7.5 laptop:px-20 desktop:px-29.5 max-w-[1920px] mx-auto flex flex-col">
      ...
      <div className="flex flex-col laptop:flex-row gap-6">
        ...
        >
          {/*
            laptop:h-[727px] cubre el rango 1200-1279px (antes de que xl: tome efecto).
            xl:h-[727px] ya estaba compilado y cubre 1280px+.
            Ambos son 727px, sin conflicto.
          */}
          <div className="cat-grid-main-card w-full h-[260px] sm:h-[380px] md:h-[500px] xl:h-[727px] relative bg-[#05162D] rounded-[20px] md:rounded-[40px] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col justify-end p-5 sm:p-6 md:p-[50px] h-full text-white">
              <div className="flex items-center gap-1.5 sm:gap-3 mb-2 md:mb-3 whitespace-nowrap overflow-hidden">
                ...
                {mainArticle.fecha_publicacion && (
                  <span className="text-[11px] sm:text-sm md:text-[18px] font-medium opacity-90 shrink-0">
        ...
        {/*
          ...
          justify-between sin prefijo aplica siempre (ya compilado).
        */}
                ...
                */}
                ...
                <div className="flex flex-col flex-1 justify-center py-1">
                  {article.categoria?.nombre && (
                    <span className="text-xs tablet:text-[16px] laptop:text-[13px] desktop:text-[16px] font-medium text-[#667085] mb-1 md:mb-[8px]">
                      {article.categoria.nombre}
                    </span>
                  )}
                  <h4 className="cat-grid-title font-bold text-[#05162D] text-sm tablet:text-[22px] laptop:text-[18px] desktop:text-[28px] leading-tight tracking-tight md:tracking-[-0.56px] group-hover:text-[#043F9F] transition-colors mb-1 md:mb-3">
                    {article.titulo}
                  </h4>
