...
export interface ApiAudienciaAudiencia extends Struct.SingleTypeSchema {
  collectionName: 'audiencias';
  info: {
    description: 'Slides de la secci\u00F3n de audiencia del Home';
    displayName: 'Audiencia';
    pluralName: 'audiencias';
    singularName: 'audiencia';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::audiencia.audiencia'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slides: Schema.Attribute.Component<'audiencia.slides', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::audiencia.audiencia': ApiAudienciaAudiencia;
